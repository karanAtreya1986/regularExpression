...
public class QuantifierClasses5 {

	public static void main(String[] args) {

		// + means value can come once or infinite times.
		// only one character can match once or infinite times.
		// either "a or m or n" in string can be present once or infinite times.
		...
		// value will be false as the rules.
